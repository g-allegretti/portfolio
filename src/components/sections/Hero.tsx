    ...
    >
      <div className="max-w-3xl">
        ...
        <p className="text-slate-400 text-lg leading-relaxed max-w-2xl mb-10">
          I design and build complex performance-critical systems end-to-end — from low-level C++
          pipeline architecture and DNN inference backends to Qt/QML frontends and CI/CD infrastructure.
          Five years across railway inspection, avionics, and robotics.
        </p>
