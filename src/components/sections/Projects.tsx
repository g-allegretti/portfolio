  ...
  return (
    <div className="bg-[#161616] border border-[#2a2a2a] rounded-lg overflow-hidden flex flex-col hover:border-[#f59e0b]/40 transition-colors group">
          ...
          <div className="relative w-full aspect-[16/7] overflow-hidden rounded">
            <img
              ...
              className={`w-full h-full object-cover object-top transition-transform duration-300 ${
                p.private ? 'blur-[2px] scale-105' : 'group-hover:scale-[1.02]'
              }`}
            />
            {p.private && (
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-[#0c0c0c]/10">
                <svg className="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                </svg>
                <span className="text-xs text-slate-300 font-mono">Private repository</span>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="p-6 flex flex-col gap-4 flex-1">
        ...
        {p.private && (
          <a
            href="mailto:giovanni.allegretti93@gmail.com?subject=Source code request"
            className="inline-flex items-center gap-2 text-sm text-slate-400 hover:text-[#f59e0b] transition-colors"
          >
